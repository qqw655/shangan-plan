...
const PHASES = [
  {
    ...
    modules: [
      { name: "资料分析", min: 100, what: "公式+速算+限时 20 题——你的主攻，目标 90%+" },
      { name: "判断逻辑", min: 65, what: "翻译推理公式化（补 0 分项）+ 加强削弱 25 题" },
      { name: "言语理解", min: 50, what: "逻辑填空（背高频成语）+ 中心理解 25 题" },
      { name: "数量·数推", min: 40, what: "数推四类套路（多重/机械划分/递推/图形数阵）10 题 + 运算挑 3 题" },
      { name: "图推+科学", min: 35, what: "图推立体类优先；科学推理补初中物理（受力/运动/功）" },
      ...
      { name: "时政", min: 15, what: "全会公报 + 重要文件 + 广东本地，只跟时政" }
    ]
  },
  {
    name: "巩固期",
    ...
    modules: [
      { name: "资料分析", min: 100, what: "限时提速（一套材料 30 分钟），综合判断用排除法" },
      { name: "判断逻辑", min: 60, what: "加强/削弱/组合排列真题 30 题，翻译保持手感" },
      { name: "言语理解", min: 40, what: "25 题保持手感，逻辑填空为重点" },
      { name: "数量·数推", min: 40, what: "数推 15 分钟保手感；运算只练高频 6 类，每题≤1.5 分钟" },
      { name: "图推+科学", min: 30, what: "图推规律类扫题；科学推理物理为主" },
      ...
      { name: "时政", min: 10, what: "时政 + 广东本地（大湾区/高质量发展）" }
    ]
  },
  {
    name: "套题期",
    ...
    modules: [
      { name: "行测套题", min: 120, what: "隔天一套全真计时 + 复盘（按周测侧重微调）", freq: "隔天" },
      { name: "申论套题", min: 90, what: "每周 2 套广东申论真题（限时 90 分钟），踩点复盘", freq: "每周2次" },
      { name: "公专套题", min: 90, what: "整套限时 + 知识点回顾", freq: "每周2次" },
      { name: "资料保持", min: 30, what: "每天 20 题限时，保持 90%+" },
      { name: "判断+言语保持", min: 40, what: "各 20 题保持手感" },
